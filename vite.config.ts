...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Farmaline - Smart Agricultural Platform",
        short_name: "Farmaline",
        description: "Connect farmers, consumers, and retailers with AI-powered agriculture solutions",
        theme_color: "#16a34a",
        ...
        shortcuts: [
          {
            name: "Marketplace",
            url: "/marketplace",
            description: "Browse farm products"
          },
          {
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'vendor-utils': ['framer-motion', 'sonner', 'date-fns', 'leaflet', 'react-leaflet', 'recharts', 'clsx', 'tailwind-merge'],
        },
      },
    },
